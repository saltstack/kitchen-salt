  ...
  module Provisioner
    ...
    class SaltSolo < Base
      ...
      DEFAULT_CONFIG = {
        ...
        remote_states: nil,
        require_chef: true,
        salt_apt_repo_key: 'https://repo.saltproject.io/salt/py3/ubuntu/20.04/amd64/latest/SALT-PROJECT-GPG-PUBKEY-2023.gpg',
        salt_apt_repo: 'https://repo.saltproject.io/salt/py3/ubuntu/20.04/amd64',
        ...
        salt_version: 'latest',
        salt_yum_repo_key: 'https://repo.saltproject.io/salt/py3/redhat/$releasever/$basearch/minor/%s/SALT-PROJECT-GPG-PUBKEY-2023.pub',
        salt_yum_repo_latest: 'https://repo.saltproject.io/salt/py3/redhat/$releasever/$basearch/latest.repo',
        salt_yum_repo: 'https://repo.saltproject.io/yum/redhat/$releasever/$basearch/minor/%s.repo',
        salt_yum_rpm_key: 'https://repo.saltproject.io/salt/py3/redhat/7/x86_64/minor/%s/SALT-PROJECT-GPG-PUBKEY-2023.pub',
